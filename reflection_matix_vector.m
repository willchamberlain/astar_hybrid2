function reflection_matrix_SO3__ = reflection_matix_vector(vector_to_reflect_against_, reflection_origin_)
% vector_to_reflect_against_ :  vector to reflect against
% return : reflection_matrix_SO3__ : reflection transformation matrix SO3 
    plane_normal_vec = vector_to_reflect_against_ ;      %  vector to reflect _along_ . The cross-product is the normal : in the xy-plane

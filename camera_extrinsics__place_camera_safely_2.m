...
%}
function [camera__ , target_point__ ] = camera_extrinsics__place_camera_safely_2(min_angle_degs_,angle_range_degs_, x_max, y_max, z_max, camera_gauss_scale_, target_gauss_scale_, points_3D_,proportion_in_fov_)
    while true
        target_point__ = points_3D_(:,randi(size(points_3D_,2))) + (rand(([3,1]))-0.5).*target_gauss_scale_; 
        camera__ = camera_extrinsics__place_camera_2(min_angle_degs_,angle_range_degs_, x_max, y_max, z_max, camera_gauss_scale_, target_point__);

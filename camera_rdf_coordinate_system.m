function camera_rdf_coordinate_system_SO3__ = camera_rdf_coordinate_system( vector_along_x_axis_ , vector_in_z_axis_plane_ )
% Calculates the _orientation_  of coordinate system in RDF (z-foward/z-optical-axis, x-right, y-down )

...
%%
    ...
    exp_run_output_dir = strcat('/mnt/nixbig/ownCloud/project_code/plan_to_observe/plan_to_observe_2a/',datetostr(exp_run_start_time,'s'))  ;
    ...
    % RUN the thing
        ...
        %     sampling__x(ii_) = sin(ii_)  ;
        %     sampling__y(ii_) = cos(ii_)  ;    
        % end    
...
save(  strcat(exp_run_output_dir,'/','plan_to_observe_2a_',datetostr(exp_run_start_time),'.m')  )

...
%{
Same as plan_to_observe_2b_b_cone.m,  but evaluate and step AStar at each iteration.
    AStar  -  
...
using_narrow_costmap = false; if using_narrow_costmap; costmap_obs_dist_narrow = ones(floorplan_extent_cells(1),floorplan_extent_cells(2))  ; end;
...
%             end;
            ...
            [line1_exit__, line2_exit__, line2_exit_to_line1_exit_vec__, dist__] = ...
                shortestLineBetweenLineSegments(  ...
                robot_posn_prediction_vec_1(:,2) , target_posn_prediction_vec(:,2)  ,  ...
                [xx_,yy_] , [xx_,yy_]  )  ;
            if dist__ < dist_cell_to_target
                dist_cell_to_target = dist__ ;     
            end;
            [line1_exit__, line2_exit__, line2_exit_to_line1_exit_vec__, dist__] = ...
                shortestLineBetweenLineSegments(  ...
                robot_posn_prediction_vec_2(:,2) , target_posn_prediction_vec(:,2)  ,  ...
                [xx_,yy_] , [xx_,yy_]  )  ;
            if dist__ < dist_cell_to_target
                dist_cell_to_target = dist__ ;     
            end;
...
%     costmap_obs_dist_narrow = costmap_obs_dist_narrow .* 0.5  ;
   % costmap_obs_dist = costmap_obs_dist_narrow.*costmap_obs_dist;
        ...
        if debug_costmaps;  figure(fig_costmap_obs_dist_narrow);  surf(costmap_obs_dist); surf(costmap_obs_dist_narrow);    end;    
...
%     costmap_dist_to_path_follower(costmap_dist_to_path_follower>0.2)  ;
    ...
    %  start next step calculation                
            ...
            map_1 = costmap_total + 20;  %costmap_total ;
            start_1 = robot_posn  ;

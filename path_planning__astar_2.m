function [ path__ , f_score, g_score , came_from, open_set, closed_set ] = path_planning__astar_2(cost_map_, start_, goal_)
...
%                     path__ = reconstruct_path(came_from, current_node_index)
                ...
                kk_ = 0;
                for current_row_ii_ = current_row_ - 1 : current_row_ + 1
                    for current_col_jj_ = current_col_ - 1 : current_col_ + 1
                        kk_ = kk_ + 1;
                        costs_of_neighbours(kk_) = abs( goal(1) - current_row_ii_  ) +  abs( current_col_jj_ - goal(2)  )    ;
                    end
                end                
                ...
                if (current_row_ == 8 || current_row_ == 9) && current_col_==3 
                    aaaa = 5
                end

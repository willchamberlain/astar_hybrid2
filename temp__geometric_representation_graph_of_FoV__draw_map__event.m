function figure_handle__ = temp__geometric_representation_graph_of_FoV__draw_map__event( ...
    ...
    set(figure_handle__,'WindowButtonDownFcn',@callBack_geometric_representation_graph_of_FoV)  ;

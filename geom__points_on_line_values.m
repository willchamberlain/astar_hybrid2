function vaues_of_cells_on_line__ = geom__points_on_line_values( start_2d_vec_, end_2d_vec_ , map_2  )
...
%
x_start = start_2d_vec_(1)  ;   y_start=start_2d_vec_(2)  ;
x_end = end_2d_vec_(1)  ;   y_end=end_2d_vec_(2)  ;
